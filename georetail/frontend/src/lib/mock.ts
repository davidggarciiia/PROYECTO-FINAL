...
function buildBaseExplanations(): Record<string, ExplicacionDimension> {
  return {
    ...
    dinamismo: dim(
      61,
      "Dinamismo sano, sin euforia",
      "La zona mantiene actividad comercial suficiente para reducir riesgo, aunque no muestra una aceleracion explosiva.",
      ["La supervivencia historica acompana.", "Hay actividad comercial recurrente en el entorno."],
      ["La tendencia no compensa por si sola el flujo peatonal bajo."],
      ["Tendencia comercial: estable", "Supervivencia 3 anos: 68%", "Ratio aperturas/cierres: x1.1"],
      "Aporta estabilidad, pero no es el motor principal del score.",
      ["v_dinamismo_zona", "Llicencies BCN", "Cens comercial"],
      "media"
    ),
  };
}
...
function buildBaseImpact(): Record<string, ImpactoModeloDimension> {
  return {
    ...
    dinamismo: impact(0.06, "neutral", [
      { feature: "ratio_apertura_cierre_1a", valor: 1.1, descripcion: "Actividad comercial estable." },
    ]),
  };
}
...
const BASE_DETAIL: LocalDetalleResponse = {
  zona: {
    ...
    precio_alquiler_m2: 27,
    hhi_index: 0.24,
    num_directos: 2,
    num_bicing_400m: 3,
    tendencia: "estable",
    tasa_supervivencia_3a: 0.68,
    ratio_apertura_cierre_1a: 1.1,
    hhi_sectorial: 0.21,
    negocios_historico_count: 105,
    renta_variacion_3a: 2.4,
    dist_playa_m: 4200,
...
const DETAIL_OVERRIDES: Record<string, Partial<LocalDetalleResponse["zona"]>> = {
  "eixample-consell-cent": {
    ...
    precio_alquiler_m2: 29,
    hhi_index: 0.38,
    num_directos: 5,
    num_bicing_400m: 8,
    tendencia: "emergente",
    tasa_supervivencia_3a: 0.76,
    ratio_apertura_cierre_1a: 1.35,
    hhi_sectorial: 0.28,
    negocios_historico_count: 287,
    renta_variacion_3a: 4.1,
    dist_playa_m: 3100,
    resumen_global_llm:
  ...
  "poble-nou-rambla": {
    ...
    precio_alquiler_m2: 21,
    hhi_index: 0.17,
    num_directos: 1,
    num_bicing_400m: 5,
    tendencia: "emergente",
    tasa_supervivencia_3a: 0.72,
    ratio_apertura_cierre_1a: 1.42,
    hhi_sectorial: 0.16,
    negocios_historico_count: 143,
    renta_variacion_3a: 5.8,
    dist_playa_m: 850,
    resumen_global_llm:
...
export function getMockCompetencia(zona_id: string): CompetenciaDetalle {
  ...
  return {
    ...
    amenaza: [
      {
        ...
        precio_nivel: 3,
        es_competencia_directa: true,
        es_competencia_directa_subsector: true,
        amenaza_score: 82,
        resenas_resumen: {
          total: 182,
          positivas: 155,
          ...
          neutras: 13,
          rating_medio: 4.75,
          temas_top: ["servicio", "ambiente", "producto"],
          ultima_fecha: "2026-03-14",
        },
        resenas_destacadas: [
          {
            texto: "Trabajo impecable y muy buen trato. El estudio transmite confianza desde la primera visita.",
            rating: 5,
            fecha: "2026-03-14",
          ...
          {
            texto: "Precio alto, pero se nota la experiencia del equipo y el cuidado del diseño.",
            rating: 4,
            fecha: "2026-02-11",
            sentimiento: "positivo",
            categoria: "precio",
      ...
      },
      {
        ...
        resenas_resumen: {
          ...
          neutras: 10,
          rating_medio: 4.42,
          temas_top: ["producto", "servicio", "ambiente"],
          ultima_fecha: "2026-01-22",
        },
        resenas_destacadas: [
          {
            texto: "Buen resultado final, aunque tuve que esperar bastante pese a tener cita.",
            rating: 3,
            fecha: "2026-01-22",
            sentimiento: "neutro",
            categoria: "servicio",
    ...
    oportunidad: [
      {
        ...
        resenas_resumen: {
          ...
          neutras: 5,
          rating_medio: 3.7,
          temas_top: ["servicio", "precio"],
          ultima_fecha: "2026-02-03",
        },
        resenas_destacadas: [
          {
            texto: "El tatuaje quedó bien, pero la comunicación antes de la cita fue confusa.",
            rating: 3,
            fecha: "2026-02-03",
            sentimiento: "neutro",
            categoria: "servicio",
          ...
          {
            texto: "Me cambiaron la hora dos veces y no me dieron una solución clara.",
            rating: 2,
            fecha: "2026-01-08",
    ...
    sinergicos: [
      {
        id: "mock-peluqueria-gracia",
        nombre: "Peluquería Gràcia",
        sector: "Belleza",
        subsector: "hair_salon",
        lat: zona.lat - 0.0004,
        lng: zona.lng - 0.0005,
        distancia_m: 80,
        rating: 4.2,
        ...
        resenas_resumen: {
          ...
          neutras: 8,
          rating_medio: 4.2,
          temas_top: ["servicio", "ambiente"],
          ultima_fecha: "2026-02-18",
        },
        resenas_destacadas: [
          {
            texto: "Servicio cercano y clientela de barrio, suele estar lleno por las tardes.",
            rating: 5,
            fecha: "2026-02-18",
            sentimiento: "positivo",
            categoria: "servicio",
      ...
      },
      {
        ...
        resenas_resumen: {
          ...
          neutras: 31,
          rating_medio: 4.05,
          temas_top: ["ambiente", "precio", "ubicacion"],
          ultima_fecha: "2026-03-05",
        },
        resenas_destacadas: [
          {
            texto: "Buen punto de encuentro antes de moverse por Gràcia. Terraza pequeña pero agradable.",
            rating: 4,
            fecha: "2026-03-05",
            sentimiento: "positivo",
            categoria: "ubicacion",
