...
function BarcelonaSkyline() {
  ...
  const windows: Array<{ x: number; y: number; d: number; dur: number }> = [
    // Block 1 — x:[20,98] y:[240,360]
    { x: 62, y: 245, d: 0.2, dur: 5.5 },
    { x: 62, y: 262, d: 1.1, dur: 6.5 },
    { x: 62, y: 279, d: 2.3, dur: 7 },
    { x: 80, y: 245, d: 0.6, dur: 5 },
    { x: 80, y: 262, d: 1.9, dur: 8 },
    // Block 2 — x:[105,187] y:[205,360]
    { x: 140, y: 210, d: 0.4, dur: 6 },
    { x: 158, y: 210, d: 1.5, dur: 7.2 },
    { x: 140, y: 230, d: 2.1, dur: 5.8 },
    { x: 158, y: 230, d: 0.9, dur: 9 },
    { x: 140, y: 250, d: 2.8, dur: 6.2 },
    { x: 158, y: 250, d: 1.2, dur: 7.5 },
    // Sagrada Familia spires — x fixed inside spire bodies (spire2: 228-240, spire3: 246-258)
    { x: 231, y: 135, d: 0.1, dur: 6.6 },
    { x: 248, y: 135, d: 1.7, dur: 5.3 },
    { x: 231, y: 155, d: 2.6, dur: 8.1 },
    { x: 248, y: 155, d: 0.8, dur: 5.9 },
    { x: 231, y: 175, d: 3.2, dur: 7 },
    { x: 248, y: 175, d: 1.4, dur: 6.3 },
    { x: 231, y: 195, d: 2.2, dur: 8.8 },
    { x: 248, y: 195, d: 0.3, dur: 5.4 },
    // Block 3 — x:[298,370] y:[195,360]
    { x: 310, y: 200, d: 1.0, dur: 6.7 },
    { x: 328, y: 200, d: 2.4, dur: 5.2 },
    { x: 310, y: 220, d: 0.7, dur: 7.4 },
    { x: 328, y: 220, d: 1.8, dur: 8.5 },
    { x: 310, y: 240, d: 2.9, dur: 6 },
    // Block 4 — x:[384,446] y:[235,360]
    { x: 396, y: 245, d: 0.5, dur: 7.1 },
    { x: 414, y: 245, d: 1.6, dur: 5.7 },
    { x: 396, y: 263, d: 2.7, dur: 8.3 },
    { x: 414, y: 263, d: 1.3, dur: 6.4 },
  ];
