-- ============================================================
-- Archivo  : 99_seed_variables_zona.sql
-- Proyecto : GeoRetail
-- Propósito: Seeds sintéticos variables_zona — datos realistas de BCN
--            distribuidos en coordinadora + 5 satélites.
-- Orden    : Ejecutar después de 98_seed_demo.sql.
--            Depende de: zonas, barrios, distritos, variables_zona,
--            vz_flujo, vz_demografia, vz_comercial, vz_turismo, vz_entorno.
-- ============================================================

-- ── variables_zona (coordinadora) ──────────────────────────────────────────────
INSERT INTO variables_zona (zona_id, fecha, fuente)
SELECT z.id, CURRENT_DATE, 'seed_barcelona_v1'
FROM zonas z
...
SELECT
    ...
    -- Población
    GREATEST(1000, 2500 + (hashtext(z.id || 'pob') % 4000))
                                        AS poblacion,
...
SELECT
    ...
    -- Ratio locales comerciales (CHECK 0..1)
