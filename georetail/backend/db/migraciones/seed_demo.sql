-- Seed data para demo — ~240 zonas de Barcelona
-- Ejecutar: psql $DATABASE_URL < seed_demo.sql
...
INSERT INTO locales (id, zona_id, lat, lng, m2, planta, alquiler_mensual, disponible, escaparate_ml)
SELECT
  'loc_' || z.id,
  z.id,
