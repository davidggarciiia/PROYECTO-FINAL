...
SECTOR_PROFILE_DEFAULTS: dict[str, dict[str, float]] = {
    ...
    "hogar": {
        "dependencia_flujo": 0.45,
        "nivel_precio": 0.58,
        "clientela_turismo": 0.12,
        "clientela_vecindario": 0.55,
        "horario_nocturno": 0.00,
        "experiencial": 0.40,
        "citas_previas": 0.10,
        "sensibilidad_alquiler": 0.55,
...
BASE_VARIANTS_BY_SECTOR = {
    "restauracion": [
        ...
        ("vermut_bar", "Vermut bar", ["vermut", "vermouth bar", "bodega vermut", "aperitivo"], "vermut_aperitivo", {"dependencia_flujo": 0.72, "nivel_precio": 0.42, "clientela_turismo": 0.38, "clientela_vecindario": 0.58, "horario_nocturno": 0.20, "experiencial": 0.62, "sensibilidad_alquiler": 0.50}, {"flujo_min": 500.0, "ratio_comercial_min": 0.18}, None),
        ("tapas_bar", "Tapas bar", ["tapas", "bar de tapas", "pinchos bar", "pintxos"], None, {"dependencia_flujo": 0.82, "nivel_precio": 0.40, "clientela_turismo": 0.42, "clientela_vecindario": 0.42, "horario_nocturno": 0.30, "experiencial": 0.46, "sensibilidad_alquiler": 0.60}, {"flujo_min": 550.0, "ratio_comercial_min": 0.22}, None),
        ("sushi_counter", "Sushi counter", ["sushi", "japonés", "japanese food", "ramen"], None, {"dependencia_flujo": 0.68, "nivel_precio": 0.56, "clientela_turismo": 0.34, "clientela_vecindario": 0.40, "experiencial": 0.44, "sensibilidad_alquiler": 0.52}, {"flujo_min": 420.0, "ratio_comercial_min": 0.20}, None),
        ("smoothie_bar", "Smoothie and acai bar", ["smoothie bar", "acai bowl", "zumos naturales", "healthy fast food"], None, {"dependencia_flujo": 0.80, "nivel_precio": 0.48, "clientela_turismo": 0.28, "clientela_vecindario": 0.38, "experiencial": 0.36, "sensibilidad_alquiler": 0.64}, {"flujo_min": 600.0, "ratio_comercial_min": 0.24}, None),
    ],
    "moda": [
        ...
        ("kids_fashion", "Kids fashion store", ["moda infantil", "ropa niños", "kids store"], None, {"dependencia_flujo": 0.52, "nivel_precio": 0.52, "clientela_turismo": 0.08, "clientela_vecindario": 0.72, "experiencial": 0.28, "sensibilidad_alquiler": 0.56}, {"zonas_verdes_bonus": 0.40, "seguridad_min": 68.0}, None),
        ("sportswear_store", "Sportswear store", ["ropa deportiva", "sportswear", "tienda deporte ropa"], None, {"dependencia_flujo": 0.66, "nivel_precio": 0.54, "clientela_turismo": 0.14, "clientela_vecindario": 0.38, "experiencial": 0.32, "sensibilidad_alquiler": 0.52}, {"ratio_comercial_min": 0.26}, None),
        ("accessories_store", "Accessories store", ["complementos", "bolsos", "bisutería", "accessories boutique"], None, {"dependencia_flujo": 0.70, "nivel_precio": 0.58, "clientela_turismo": 0.26, "clientela_vecindario": 0.32, "experiencial": 0.40, "sensibilidad_alquiler": 0.44}, {"ratio_comercial_min": 0.24}, None),
    ],
    "estetica": [
        ...
        ("tanning_studio", "Tanning studio", ["centro bronceado", "solarium", "tanning studio"], None, {"dependencia_flujo": 0.26, "nivel_precio": 0.46, "clientela_turismo": 0.12, "clientela_vecindario": 0.60, "experiencial": 0.30, "citas_previas": 0.70, "sensibilidad_alquiler": 0.56}, {"seguridad_min": 56.0}, None),
        ("massage_center", "Massage and relaxation center", ["masajes", "centro masajes", "massage center", "shiatsu", "thai massage"], None, {"dependencia_flujo": 0.18, "nivel_precio": 0.58, "clientela_turismo": 0.20, "clientela_vecindario": 0.58, "experiencial": 0.72, "citas_previas": 0.82, "sensibilidad_alquiler": 0.44}, {"seguridad_min": 60.0}, None),
    ],
    "tatuajes": [
    ...
    "salud": [
        ...
        ("nutritionist", "Nutritionist and dietitian center", ["nutricionista", "dietista", "nutrition center", "dieta"], None, {"dependencia_flujo": 0.10, "nivel_precio": 0.52, "clientela_turismo": 0.04, "clientela_vecindario": 0.72, "citas_previas": 0.96, "experiencial": 0.14, "sensibilidad_alquiler": 0.36}, {"seguridad_min": 58.0}, None),
        ("osteopathy", "Osteopathy and manual therapy", ["osteopatia", "quiropraxis", "osteopathy", "manual therapy"], None, {"dependencia_flujo": 0.08, "nivel_precio": 0.60, "clientela_turismo": 0.04, "clientela_vecindario": 0.72, "citas_previas": 0.98, "experiencial": 0.22, "sensibilidad_alquiler": 0.32}, {"seguridad_min": 58.0}, None),
        ("veterinary_clinic", "Veterinary clinic", ["veterinaria", "vet clinic", "clinica veterinaria"], None, {"dependencia_flujo": 0.22, "nivel_precio": 0.56, "clientela_turismo": 0.02, "clientela_vecindario": 0.88, "citas_previas": 0.78, "experiencial": 0.14, "sensibilidad_alquiler": 0.42}, {"zonas_verdes_bonus": 0.50, "seguridad_min": 60.0}, None),
    ],
    "deporte": [
        ...
        ("padel_club", "Padel club", ["padel", "club de padel", "padel court"], None, {"dependencia_flujo": 0.14, "nivel_precio": 0.52, "clientela_turismo": 0.06, "clientela_vecindario": 0.62, "experiencial": 0.50, "citas_previas": 0.78, "sensibilidad_alquiler": 0.62}, {"seguridad_min": 56.0}, None),
        ("cycling_studio", "Indoor cycling studio", ["ciclismo indoor", "spinning studio", "cycling studio"], None, {"dependencia_flujo": 0.12, "nivel_precio": 0.66, "clientela_turismo": 0.06, "clientela_vecindario": 0.58, "experiencial": 0.62, "citas_previas": 0.72, "sensibilidad_alquiler": 0.50}, {"seguridad_min": 58.0}, None),
        ("swimming_club", "Swimming and aquatic club", ["natacion", "club natacion", "piscina", "aquatic center"], None, {"dependencia_flujo": 0.10, "nivel_precio": 0.48, "clientela_turismo": 0.04, "clientela_vecindario": 0.68, "experiencial": 0.38, "citas_previas": 0.58, "sensibilidad_alquiler": 0.68}, {"seguridad_min": 58.0, "zonas_verdes_bonus": 0.30}, None),
    ],
    "educacion": [
        ...
        ("cooking_school", "Cooking school", ["escuela de cocina", "taller cocina", "cooking school", "cocina creativa"], None, {"dependencia_flujo": 0.14, "nivel_precio": 0.58, "clientela_turismo": 0.18, "clientela_vecindario": 0.56, "experiencial": 0.74, "citas_previas": 0.88, "sensibilidad_alquiler": 0.40}, {"seguridad_min": 56.0}, None),
        ("driving_school", "Driving school", ["autoescuela", "driving school", "permiso conducir"], None, {"dependencia_flujo": 0.24, "nivel_precio": 0.46, "clientela_turismo": 0.02, "clientela_vecindario": 0.76, "experiencial": 0.12, "citas_previas": 0.92, "sensibilidad_alquiler": 0.52}, {"seguridad_min": 56.0}, None),
        ("creative_workshop", "Creative and craft workshop", ["taller creativo", "manualidades", "pottery class", "ceramica", "craft workshop"], None, {"dependencia_flujo": 0.16, "nivel_precio": 0.54, "clientela_turismo": 0.16, "clientela_vecindario": 0.60, "experiencial": 0.78, "citas_previas": 0.80, "sensibilidad_alquiler": 0.42}, {"seguridad_min": 56.0}, None),
    ],
    "alimentacion": [
        ...
        ("organic_market", "Organic and eco market", ["tienda ecologica", "organico", "eco shop", "productos bio", "zero waste shop"], "eco_organico", {"dependencia_flujo": 0.40, "nivel_precio": 0.62, "clientela_turismo": 0.10, "clientela_vecindario": 0.76, "experiencial": 0.30, "sensibilidad_alquiler": 0.50}, {"ratio_comercial_min": 0.14}, None),
        ("asian_grocery", "Asian grocery and food", ["alimentacion asiatica", "supermercado asiatico", "asian grocery", "productos orientales"], None, {"dependencia_flujo": 0.50, "nivel_precio": 0.28, "clientela_turismo": 0.16, "clientela_vecindario": 0.78, "sensibilidad_alquiler": 0.72}, {"flujo_min": 280.0}, None),
        ("cheese_shop", "Artisan cheese shop", ["queseria", "quesos artesanos", "cheese shop", "delicatessen queso"], None, {"dependencia_flujo": 0.32, "nivel_precio": 0.70, "clientela_turismo": 0.18, "clientela_vecindario": 0.68, "experiencial": 0.30, "sensibilidad_alquiler": 0.42}, {"ratio_comercial_min": 0.14}, None),
        ("coffee_roaster", "Coffee roaster and specialty beans", ["tostador cafe", "coffee roaster", "granos cafe", "specialty beans"], None, {"dependencia_flujo": 0.28, "nivel_precio": 0.72, "clientela_turismo": 0.16, "clientela_vecindario": 0.62, "experiencial": 0.42, "sensibilidad_alquiler": 0.40}, {"ratio_comercial_min": 0.14}, None),
    ],
    "servicios": [
        ...
        ("dry_cleaning", "Dry cleaning and laundry", ["tintoreria", "lavanderia profesional", "dry cleaning", "arreglos ropa"], None, {"dependencia_flujo": 0.44, "nivel_precio": 0.26, "clientela_turismo": 0.06, "clientela_vecindario": 0.88, "citas_previas": 0.20, "sensibilidad_alquiler": 0.74}, {"flujo_min": 250.0}, None),
        ("photo_studio", "Photo and video studio", ["estudio fotografia", "photo studio", "sesiones foto", "fotografia profesional"], None, {"dependencia_flujo": 0.14, "nivel_precio": 0.60, "clientela_turismo": 0.16, "clientela_vecindario": 0.52, "experiencial": 0.52, "citas_previas": 0.86, "sensibilidad_alquiler": 0.40}, {"seguridad_min": 56.0}, None),
        ("travel_agency", "Travel agency", ["agencia viajes", "travel agency", "turismo organizado", "vuelos hoteles"], None, {"dependencia_flujo": 0.36, "nivel_precio": 0.44, "clientela_turismo": 0.08, "clientela_vecindario": 0.70, "experiencial": 0.20, "citas_previas": 0.64, "sensibilidad_alquiler": 0.60}, {"flujo_min": 200.0}, None),
    ],
    "hogar": [
        ("furniture_store", "Furniture and home store", ["tienda muebles", "furniture store", "mobiliario"], None, {"dependencia_flujo": 0.38, "nivel_precio": 0.62, "clientela_turismo": 0.08, "clientela_vecindario": 0.60, "experiencial": 0.44, "citas_previas": 0.18, "sensibilidad_alquiler": 0.52}, {"ratio_comercial_min": 0.14}, None),
        ("home_textiles", "Home textiles and bedding", ["textil hogar", "ropa cama", "cortinas", "alfombras", "home textiles"], None, {"dependencia_flujo": 0.40, "nivel_precio": 0.56, "clientela_turismo": 0.10, "clientela_vecindario": 0.62, "experiencial": 0.36, "sensibilidad_alquiler": 0.56}, {"ratio_comercial_min": 0.14}, None),
        ("interior_design", "Interior design studio", ["interiorismo", "decoracion interior", "interior design", "estudio interiorismo"], None, {"dependencia_flujo": 0.22, "nivel_precio": 0.76, "clientela_turismo": 0.10, "clientela_vecindario": 0.50, "experiencial": 0.60, "citas_previas": 0.64, "sensibilidad_alquiler": 0.34}, {"seguridad_min": 58.0}, None),
        ("lighting_store", "Lighting and lamp store", ["iluminacion", "lamparas", "lighting store", "luces diseño"], None, {"dependencia_flujo": 0.42, "nivel_precio": 0.64, "clientela_turismo": 0.12, "clientela_vecindario": 0.52, "experiencial": 0.46, "sensibilidad_alquiler": 0.48}, {"ratio_comercial_min": 0.16}, None),
        ("second_hand_furniture", "Second hand furniture and vintage decor", ["muebles segunda mano", "vintage decor", "second hand furniture", "anticuario"], None, {"dependencia_flujo": 0.34, "nivel_precio": 0.42, "clientela_turismo": 0.16, "clientela_vecindario": 0.54, "experiencial": 0.52, "sensibilidad_alquiler": 0.60}, {"ratio_comercial_min": 0.12}, None),
        ("kitchen_store", "Kitchen and cookware store", ["tienda cocina", "utensilios cocina", "kitchen store", "menaje"], None, {"dependencia_flujo": 0.44, "nivel_precio": 0.58, "clientela_turismo": 0.12, "clientela_vecindario": 0.58, "experiencial": 0.40, "sensibilidad_alquiler": 0.52}, {"ratio_comercial_min": 0.16}, None),
    ],
    "mascotas": [
        ("pet_shop", "Pet shop and accessories", ["tienda mascotas", "pet shop", "accesorios mascotas", "pajareria"], None, {"dependencia_flujo": 0.38, "nivel_precio": 0.44, "clientela_turismo": 0.04, "clientela_vecindario": 0.88, "experiencial": 0.28, "sensibilidad_alquiler": 0.64}, {"zonas_verdes_bonus": 0.50, "flujo_min": 240.0}, None),
        ("vet_clinic", "Veterinary clinic", ["veterinaria", "vet clinic", "clinica veterinaria", "animal clinic"], None, {"dependencia_flujo": 0.20, "nivel_precio": 0.56, "clientela_turismo": 0.02, "clientela_vecindario": 0.90, "citas_previas": 0.82, "experiencial": 0.14, "sensibilidad_alquiler": 0.44}, {"zonas_verdes_bonus": 0.40, "seguridad_min": 60.0}, None),
        ("pet_daycare", "Pet daycare and hotel", ["guarderia mascotas", "hotel mascotas", "pet daycare", "residencia canina"], None, {"dependencia_flujo": 0.16, "nivel_precio": 0.48, "clientela_turismo": 0.10, "clientela_vecindario": 0.78, "citas_previas": 0.58, "experiencial": 0.36, "sensibilidad_alquiler": 0.58}, {"zonas_verdes_bonus": 0.70, "seguridad_min": 60.0}, None),
        ("pet_grooming_salon", "Pet grooming salon", ["peluqueria canina salon", "grooming salon", "estetica mascotas"], None, {"dependencia_flujo": 0.20, "nivel_precio": 0.44, "clientela_turismo": 0.02, "clientela_vecindario": 0.92, "citas_previas": 0.74, "experiencial": 0.30, "sensibilidad_alquiler": 0.60}, {"zonas_verdes_bonus": 0.60, "seguridad_min": 60.0}, None),
        ("aquarium_shop", "Aquarium and exotic pets", ["acuarios", "peces tropicales", "tienda exoticos", "aquarium shop"], None, {"dependencia_flujo": 0.26, "nivel_precio": 0.52, "clientela_turismo": 0.08, "clientela_vecindario": 0.72, "experiencial": 0.46, "sensibilidad_alquiler": 0.60}, {"ratio_comercial_min": 0.12}, None),
    ],
    "cultura": [
        ("bookstore", "Independent bookstore", ["libreria", "bookstore", "libreria independiente", "libros"], "libreria_cultural", {"dependencia_flujo": 0.38, "nivel_precio": 0.48, "clientela_turismo": 0.24, "clientela_vecindario": 0.60, "experiencial": 0.58, "sensibilidad_alquiler": 0.54}, {"ratio_comercial_min": 0.14}, None),
        ("art_gallery", "Art gallery", ["galeria arte", "art gallery", "exposicion arte", "galeria"], "galeria_arte", {"dependencia_flujo": 0.24, "nivel_precio": 0.64, "clientela_turismo": 0.38, "clientela_vecindario": 0.42, "experiencial": 0.84, "citas_previas": 0.26, "sensibilidad_alquiler": 0.34}, {"seguridad_min": 60.0, "ratio_comercial_min": 0.12}, None),
        ("record_shop", "Record and music shop", ["tienda discos", "record shop", "vinilo", "discos musica"], None, {"dependencia_flujo": 0.40, "nivel_precio": 0.54, "clientela_turismo": 0.24, "clientela_vecindario": 0.50, "experiencial": 0.62, "sensibilidad_alquiler": 0.52}, {"ratio_comercial_min": 0.16}, None),
        ("toy_store", "Toy and games store", ["jugueteria", "toy store", "juegos educativos", "juguetes creativos"], None, {"dependencia_flujo": 0.54, "nivel_precio": 0.52, "clientela_turismo": 0.12, "clientela_vecindario": 0.72, "experiencial": 0.50, "sensibilidad_alquiler": 0.56}, {"zonas_verdes_bonus": 0.30, "seguridad_min": 66.0}, None),
        ("craft_shop", "Craft and hobby shop", ["manualidades", "craft shop", "papeleria creativa", "hobby shop", "scrapbooking"], None, {"dependencia_flujo": 0.32, "nivel_precio": 0.46, "clientela_turismo": 0.10, "clientela_vecindario": 0.68, "experiencial": 0.54, "sensibilidad_alquiler": 0.56}, {"ratio_comercial_min": 0.12}, None),
        ("cultural_space", "Cultural and community space", ["espacio cultural", "cultural space", "sala polivalente", "centro civico privado"], None, {"dependencia_flujo": 0.28, "nivel_precio": 0.44, "clientela_turismo": 0.28, "clientela_vecindario": 0.62, "experiencial": 0.80, "citas_previas": 0.38, "sensibilidad_alquiler": 0.44}, {"seguridad_min": 58.0}, None),
    ],
    "otro": [
...
RICH_MODIFIER_OVERRIDES = {
    ...
    "offer.organic": {
        "visible_tag": "eco_organico",
        "aliases": ["ecologico", "organico", "bio", "sostenible", "zero waste", "eco friendly", "residuo cero"],
        "profile": {"nivel_precio": 0.62, "clientela_vecindario": 0.64, "experiencial": 0.38},
        "visible_priority": 0.88,
    },
    "offer.artisan": {
        "visible_tag": "artesanal",
        "aliases": ["artesanal", "artisan", "hecho a mano", "handmade", "craft", "pequeño productor"],
        "profile": {"nivel_precio": 0.66, "experiencial": 0.50, "clientela_turismo": 0.20},
        "visible_priority": 0.86,
    },
    "audience.children": {
        "visible_tag": "para_ninos",
        "aliases": ["ninos", "niños", "infantil", "kids", "family kids", "children"],
        "profile": {"clientela_vecindario": 0.86, "experiencial": 0.38},
        "zone_ideal": {"seguridad_min": 70.0, "zonas_verdes_bonus": 0.60},
        "visible_priority": 0.88,
    },
    "audience.pet_owners": {
        "visible_tag": "pet_friendly",
        "aliases": ["mascotas", "animales", "pets", "dog owner", "dueños mascotas"],
        "profile": {"clientela_vecindario": 0.84, "experiencial": 0.38},
        "zone_ideal": {"zonas_verdes_bonus": 0.75, "seguridad_min": 60.0},
        "visible_priority": 0.88,
    },
    "experience.community": {
        "visible_tag": "espacio_comunitario",
        "aliases": ["comunidad", "community", "vecinos", "espacio social", "encuentro vecinal", "hub social"],
        "profile": {"clientela_vecindario": 0.90, "experiencial": 0.60, "clientela_turismo": 0.08},
        "visible_priority": 0.84,
    },
    "experience.cultural": {
        "visible_tag": "cultural_artistico",
        "aliases": ["cultural", "artistico", "galeria", "arte", "cultural space", "expresion artistica"],
        "profile": {"experiencial": 0.72, "clientela_turismo": 0.34},
        "visible_priority": 0.86,
    },
    "daypart.brunch": {
        "visible_tag": "horario_brunch",
        "aliases": ["brunch", "brunch hour", "sabado brunch", "fin de semana brunch"],
        "profile": {"horario_nocturno": 0.04, "dependencia_flujo": 0.58},
        "visible_priority": 0.80,
    },
    "ops.franchise_ready": {
        "visible_tag": "franquicia",
        "aliases": ["franquicia", "franchise", "modelo replicable", "expansion franquicia"],
        "profile": {"dependencia_flujo": 0.65, "nivel_precio": 0.52},
        "visible_priority": 0.78,
    },
}
...
SECTOR_FALLBACK_BASE = {
    ...
    "hogar": "base.hogar.furniture_store",
    "mascotas": "base.mascotas.pet_shop",
    "cultura": "base.cultura.bookstore",
